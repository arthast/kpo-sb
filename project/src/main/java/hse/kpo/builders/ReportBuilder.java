...
public class ReportBuilder {
    ...
    /**
     * Метод для добавления записи о конкретной продаже (наблюдатели будут его вызывать).
     *
     * @param customer покупатель
     * @param type тип продукта
     * @param vin уникальный идентификатор проданного товара
     * @return {@link ReportBuilder}
     */
    public ReportBuilder addSaleEntry(Customer customer, ProductionTypes type, int vin) {
        content.append(String.format("Продано: %s | VIN: %d | Покупатель: %s", type, vin, customer));
        content.append(System.lineSeparator());
        return this;
    }
